...
const TOKEN ='5383173272:AAGU-TDubphzY5OMoNE7IwW5iBRd5ZuEa1A'
...
bot.on('message',msg =>{
    ...
    if(text === '/help'){
     ...
     if(text === '/test'){
        ...
        //  })
        return bot.sendMessage(chatId,'https://drive.google.com/uc?export=download&confirm=no_antivirus&id=1jfe7n37XrsxVRsz4zQWRCM3eak9ncZ0G')
